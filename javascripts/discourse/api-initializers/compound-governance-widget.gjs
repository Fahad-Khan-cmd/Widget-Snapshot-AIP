...
export default apiInitializer((api) => {
  api.onPageChange((url) => {
    ...
    // Let Discourse + images + widgets fully settle
    ...
    // Safety net for slow layouts / zoom differences
    setTimeout(() => {
      window.scrollTo(0, 0);
    }, 300);

    // Final correction after widgets render
    setTimeout(() => {
      window.scrollTo(0, 0);
    }, 800);
  });

  console.log("✅ Stable topic scroll override active");
});
  // ---------------------------- XYZ ------------------
